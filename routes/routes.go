...
func NewRouter() *mux.Router {
	...
	r.HandleFunc("/users/{id}", middlewares.IsAuth(controllers.GetUser)).Methods("GET")
	r.HandleFunc("/users/{id}", middlewares.IsAuth(controllers.PutUser)).Methods("PUT")
	r.HandleFunc("/users/{id}", middlewares.IsAuth(controllers.DeleteUser)).Methods("DELETE")
